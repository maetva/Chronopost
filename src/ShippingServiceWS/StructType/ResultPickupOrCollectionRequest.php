...
class ResultPickupOrCollectionRequest extends AbstractStructBase
{
     ...
     * - minOccurs: 0
     * - nillable: true
     * @var \Maetva\Chronopost\ShippingServiceWS\StructType\InfoEnlevement[]
     */
     ...
     * @param \Maetva\Chronopost\ShippingServiceWS\StructType\InfoEnlevement[] $infoEnlevements
     ...
     * @param int $codeErreur
     * @return \Maetva\Chronopost\ShippingServiceWS\StructType\ResultPickupOrCollectionRequest
     */
     ...
     * @return \Maetva\Chronopost\ShippingServiceWS\StructType\InfoEnlevement[]
     */
    ...
    public static function validateInfoEnlevementsForArrayConstraintsFromSetInfoEnlevements(?array $values = []): string
    {
        ...
        foreach ($values as $resultPickupOrCollectionRequestInfoEnlevementsItem) {
            ...
            if (!$resultPickupOrCollectionRequestInfoEnlevementsItem instanceof \Maetva\Chronopost\ShippingServiceWS\StructType\InfoEnlevement) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The infoEnlevements property can only contain items of type \Maetva\Chronopost\ShippingServiceWS\StructType\InfoEnlevement, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Maetva\Chronopost\ShippingServiceWS\StructType\InfoEnlevement $item
     * @return \Maetva\Chronopost\ShippingServiceWS\StructType\ResultPickupOrCollectionRequest
     */
    public function addToInfoEnlevements(\Maetva\Chronopost\ShippingServiceWS\StructType\InfoEnlevement $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Maetva\Chronopost\ShippingServiceWS\StructType\InfoEnlevement) {
            throw new InvalidArgumentException(sprintf('The infoEnlevements property can only contain items of type \Maetva\Chronopost\ShippingServiceWS\StructType\InfoEnlevement, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
