...
class CustomsValue extends AbstractStructBase
{
     ...
     * - minOccurs: 0
     * - nillable: true
     * @var \Maetva\Chronopost\ShippingServiceWS\StructType\ArticleValue[]
     */
     ...
     * @param \Maetva\Chronopost\ShippingServiceWS\StructType\ArticleValue[] $articlesValue
     ...
     * @return \Maetva\Chronopost\ShippingServiceWS\StructType\ArticleValue[]
     */
    ...
    public static function validateArticlesValueForArrayConstraintsFromSetArticlesValue(?array $values = []): string
    {
        ...
        foreach ($values as $customsValueArticlesValueItem) {
            ...
            if (!$customsValueArticlesValueItem instanceof \Maetva\Chronopost\ShippingServiceWS\StructType\ArticleValue) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The articlesValue property can only contain items of type \Maetva\Chronopost\ShippingServiceWS\StructType\ArticleValue, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Maetva\Chronopost\ShippingServiceWS\StructType\ArticleValue $item
     * @return \Maetva\Chronopost\ShippingServiceWS\StructType\CustomsValue
     */
    public function addToArticlesValue(\Maetva\Chronopost\ShippingServiceWS\StructType\ArticleValue $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Maetva\Chronopost\ShippingServiceWS\StructType\ArticleValue) {
            throw new InvalidArgumentException(sprintf('The articlesValue property can only contain items of type \Maetva\Chronopost\ShippingServiceWS\StructType\ArticleValue, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
