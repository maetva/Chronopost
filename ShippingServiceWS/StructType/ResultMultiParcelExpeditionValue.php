...
class ResultMultiParcelExpeditionValue extends ResultShippingValue
{
     ...
     * - minOccurs: 0
     * - nillable: true
     * @var \Drupal\commerce_chronopost\Endpoint\ShippingServiceWS\StructType\ResultMultiParcelValue[]
     */
     ...
     * @param \Drupal\commerce_chronopost\Endpoint\ShippingServiceWS\StructType\ResultMultiParcelValue[] $resultMultiParcelValue
     */
     ...
     * @param string $eSDFullNumber
     * @return \Drupal\commerce_chronopost\Endpoint\ShippingServiceWS\StructType\ResultMultiParcelExpeditionValue
     */
     ...
     * @return \Drupal\commerce_chronopost\Endpoint\ShippingServiceWS\StructType\ResultMultiParcelValue[]
     */
    ...
    public static function validateResultMultiParcelValueForArrayConstraintsFromSetResultMultiParcelValue(?array $values = []): string
    {
        ...
        foreach ($values as $resultMultiParcelExpeditionValueResultMultiParcelValueItem) {
            ...
            if (!$resultMultiParcelExpeditionValueResultMultiParcelValueItem instanceof \Drupal\commerce_chronopost\Endpoint\ShippingServiceWS\StructType\ResultMultiParcelValue) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The resultMultiParcelValue property can only contain items of type \Drupal\commerce_chronopost\Endpoint\ShippingServiceWS\StructType\ResultMultiParcelValue, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Drupal\commerce_chronopost\Endpoint\ShippingServiceWS\StructType\ResultMultiParcelValue $item
     * @return \Drupal\commerce_chronopost\Endpoint\ShippingServiceWS\StructType\ResultMultiParcelExpeditionValue
     */
    public function addToResultMultiParcelValue(\Drupal\commerce_chronopost\Endpoint\ShippingServiceWS\StructType\ResultMultiParcelValue $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Drupal\commerce_chronopost\Endpoint\ShippingServiceWS\StructType\ResultMultiParcelValue) {
            throw new InvalidArgumentException(sprintf('The resultMultiParcelValue property can only contain items of type \Drupal\commerce_chronopost\Endpoint\ShippingServiceWS\StructType\ResultMultiParcelValue, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
