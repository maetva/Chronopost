...
class EsdResultContraintesAgenceValue extends AbstractStructBase
{
     ...
     * - minOccurs: 0
     * - nillable: true
     * @var \Maetva\Chronopost\ShippingServiceWS\StructType\EsdContraintesAgence[]
     */
     ...
     * @param \Maetva\Chronopost\ShippingServiceWS\StructType\EsdContraintesAgence[] $esdContraintesAgence
     ...
     * @param int $codeErreur
     * @return \Maetva\Chronopost\ShippingServiceWS\StructType\EsdResultContraintesAgenceValue
     */
     ...
     * @return \Maetva\Chronopost\ShippingServiceWS\StructType\EsdContraintesAgence[]
     */
    ...
    public static function validateEsdContraintesAgenceForArrayConstraintsFromSetEsdContraintesAgence(?array $values = []): string
    {
        ...
        foreach ($values as $esdResultContraintesAgenceValueEsdContraintesAgenceItem) {
            ...
            if (!$esdResultContraintesAgenceValueEsdContraintesAgenceItem instanceof \Maetva\Chronopost\ShippingServiceWS\StructType\EsdContraintesAgence) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The esdContraintesAgence property can only contain items of type \Maetva\Chronopost\ShippingServiceWS\StructType\EsdContraintesAgence, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Maetva\Chronopost\ShippingServiceWS\StructType\EsdContraintesAgence $item
     * @return \Maetva\Chronopost\ShippingServiceWS\StructType\EsdResultContraintesAgenceValue
     */
    public function addToEsdContraintesAgence(\Maetva\Chronopost\ShippingServiceWS\StructType\EsdContraintesAgence $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Maetva\Chronopost\ShippingServiceWS\StructType\EsdContraintesAgence) {
            throw new InvalidArgumentException(sprintf('The esdContraintesAgence property can only contain items of type \Maetva\Chronopost\ShippingServiceWS\StructType\EsdContraintesAgence, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
