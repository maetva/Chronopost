...
class ShippingMultiParcelV3 extends AbstractStructBase
{
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \Maetva\Chronopost\ShippingServiceWS\StructType\SkybillWithDimensionsValueV5[]
     */
     ...
     * @param \Maetva\Chronopost\ShippingServiceWS\StructType\SkybillWithDimensionsValueV5[] $skybillValue
     ...
     * Set esdValue value
     * @param \Maetva\Chronopost\ShippingServiceWS\StructType\EsdValue3 $esdValue
     * @return \Maetva\Chronopost\ShippingServiceWS\StructType\ShippingMultiParcelV3
     */
    ...
    public static function validateShipperValueForArrayConstraintsFromSetShipperValue(?array $values = []): string
    {
        ...
        foreach ($values as $shippingMultiParcelV3ShipperValueItem) {
            ...
            if (!$shippingMultiParcelV3ShipperValueItem instanceof \Maetva\Chronopost\ShippingServiceWS\StructType\ShipperValueV2) {
    ...
    public static function validateRecipientValueForArrayConstraintsFromSetRecipientValue(?array $values = []): string
    {
        ...
        foreach ($values as $shippingMultiParcelV3RecipientValueItem) {
            // validation for constraint: itemType
            if (!$shippingMultiParcelV3RecipientValueItem instanceof \Maetva\Chronopost\ShippingServiceWS\StructType\RecipientValueV2) {
    ...
    public static function validateRefValueForArrayConstraintsFromSetRefValue(?array $values = []): string
    {
        ...
        foreach ($values as $shippingMultiParcelV3RefValueItem) {
            // validation for constraint: itemType
            if (!$shippingMultiParcelV3RefValueItem instanceof \Maetva\Chronopost\ShippingServiceWS\StructType\RefValueV2) {
    ...
    public static function validateSkybillValueForArrayConstraintsFromSetSkybillValue(?array $values = []): string
    {
        ...
        foreach ($values as $shippingMultiParcelV3SkybillValueItem) {
            // validation for constraint: itemType
            if (!$shippingMultiParcelV3SkybillValueItem instanceof \Maetva\Chronopost\ShippingServiceWS\StructType\SkybillWithDimensionsValueV5) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The skybillValue property can only contain items of type \Maetva\Chronopost\ShippingServiceWS\StructType\SkybillWithDimensionsValueV5, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Maetva\Chronopost\ShippingServiceWS\StructType\SkybillWithDimensionsValueV5 $item
     * @return \Maetva\Chronopost\ShippingServiceWS\StructType\ShippingMultiParcelV3
     */
    public function addToSkybillValue(\Maetva\Chronopost\ShippingServiceWS\StructType\SkybillWithDimensionsValueV5 $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Maetva\Chronopost\ShippingServiceWS\StructType\SkybillWithDimensionsValueV5) {
            throw new InvalidArgumentException(sprintf('The skybillValue property can only contain items of type \Maetva\Chronopost\ShippingServiceWS\StructType\SkybillWithDimensionsValueV5, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
    ...
    public static function validateScheduledValueForArrayConstraintsFromSetScheduledValue(?array $values = []): string
    {
        ...
        foreach ($values as $shippingMultiParcelV3ScheduledValueItem) {
            // validation for constraint: itemType
            if (!$shippingMultiParcelV3ScheduledValueItem instanceof \Maetva\Chronopost\ShippingServiceWS\StructType\ScheduledValue) {
    ...
    public static function validateRecipientLocalValueForArrayConstraintsFromSetRecipientLocalValue(?array $values = []): string
    {
        ...
        foreach ($values as $shippingMultiParcelV3RecipientLocalValueItem) {
            // validation for constraint: itemType
            if (!$shippingMultiParcelV3RecipientLocalValueItem instanceof \Maetva\Chronopost\ShippingServiceWS\StructType\RecipientLocalValueV2) {
    ...
    public static function validateCustomsValueForArrayConstraintsFromSetCustomsValue(?array $values = []): string
    {
        ...
        foreach ($values as $shippingMultiParcelV3CustomsValueItem) {
            // validation for constraint: itemType
            if (!$shippingMultiParcelV3CustomsValueItem instanceof \Maetva\Chronopost\ShippingServiceWS\StructType\CustomsValue) {
