...
class ShippingMultiParcelV5 extends AbstractStructBase
{
     ...
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * @var \Maetva\Chronopost\ShippingServiceWS\StructType\HeaderValueV2|null
     */
    protected ?\Maetva\Chronopost\ShippingServiceWS\StructType\HeaderValueV2 $headerValue = null;
    /**
     * The shipperValue
     * Meta information extracted from the WSDL
     * - maxOccurs: unbounded
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \Maetva\Chronopost\ShippingServiceWS\StructType\RecipientValueV2[]
     */
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \Maetva\Chronopost\ShippingServiceWS\StructType\RefValueV2[]
     */
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \Maetva\Chronopost\ShippingServiceWS\StructType\SkybillWithDimensionsValueV6[]
     */
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \Maetva\Chronopost\ShippingServiceWS\StructType\RecipientLocalValueV2[]
     */
     ...
     * @param \Maetva\Chronopost\ShippingServiceWS\StructType\HeaderValueV2 $headerValue
     ...
     * @param \Maetva\Chronopost\ShippingServiceWS\StructType\RecipientValueV2[] $recipientValue
     * @param \Maetva\Chronopost\ShippingServiceWS\StructType\RefValueV2[] $refValue
     * @param \Maetva\Chronopost\ShippingServiceWS\StructType\SkybillWithDimensionsValueV6[] $skybillValue
     ...
     * Set esdValue value
     * @param \Maetva\Chronopost\ShippingServiceWS\StructType\EsdValue3 $esdValue
     * @return \Maetva\Chronopost\ShippingServiceWS\StructType\ShippingMultiParcelV5
     */
     ...
     * @return \Maetva\Chronopost\ShippingServiceWS\StructType\HeaderValueV2|null
     */
    public function getHeaderValue(): ?\Maetva\Chronopost\ShippingServiceWS\StructType\HeaderValueV2
    {
     ...
     * @return \Maetva\Chronopost\ShippingServiceWS\StructType\ShippingMultiParcelV5
     */
    public function setHeaderValue(?\Maetva\Chronopost\ShippingServiceWS\StructType\HeaderValueV2 $headerValue = null): self
    {
    ...
    public static function validateShipperValueForArrayConstraintsFromSetShipperValue(?array $values = []): string
    {
        ...
        foreach ($values as $shippingMultiParcelV5ShipperValueItem) {
            ...
            if (!$shippingMultiParcelV5ShipperValueItem instanceof \Maetva\Chronopost\ShippingServiceWS\StructType\ShipperValueV2) {
     ...
     * @return \Maetva\Chronopost\ShippingServiceWS\StructType\RecipientValueV2[]
     */
    ...
    public static function validateRecipientValueForArrayConstraintsFromSetRecipientValue(?array $values = []): string
    {
        ...
        foreach ($values as $shippingMultiParcelV5RecipientValueItem) {
            // validation for constraint: itemType
            if (!$shippingMultiParcelV5RecipientValueItem instanceof \Maetva\Chronopost\ShippingServiceWS\StructType\RecipientValueV2) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The recipientValue property can only contain items of type \Maetva\Chronopost\ShippingServiceWS\StructType\RecipientValueV2, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Maetva\Chronopost\ShippingServiceWS\StructType\RecipientValueV2 $item
     * @return \Maetva\Chronopost\ShippingServiceWS\StructType\ShippingMultiParcelV5
     */
    public function addToRecipientValue(\Maetva\Chronopost\ShippingServiceWS\StructType\RecipientValueV2 $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Maetva\Chronopost\ShippingServiceWS\StructType\RecipientValueV2) {
            throw new InvalidArgumentException(sprintf('The recipientValue property can only contain items of type \Maetva\Chronopost\ShippingServiceWS\StructType\RecipientValueV2, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
    ...
    /**
     * Get refValue value
     * @return \Maetva\Chronopost\ShippingServiceWS\StructType\RefValueV2[]
     */
    ...
    public static function validateRefValueForArrayConstraintsFromSetRefValue(?array $values = []): string
    {
        ...
        foreach ($values as $shippingMultiParcelV5RefValueItem) {
            // validation for constraint: itemType
            if (!$shippingMultiParcelV5RefValueItem instanceof \Maetva\Chronopost\ShippingServiceWS\StructType\RefValueV2) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The refValue property can only contain items of type \Maetva\Chronopost\ShippingServiceWS\StructType\RefValueV2, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Maetva\Chronopost\ShippingServiceWS\StructType\RefValueV2 $item
     * @return \Maetva\Chronopost\ShippingServiceWS\StructType\ShippingMultiParcelV5
     */
    public function addToRefValue(\Maetva\Chronopost\ShippingServiceWS\StructType\RefValueV2 $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Maetva\Chronopost\ShippingServiceWS\StructType\RefValueV2) {
            throw new InvalidArgumentException(sprintf('The refValue property can only contain items of type \Maetva\Chronopost\ShippingServiceWS\StructType\RefValueV2, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
        $this->refValue[] = $item;
     ...
     * @return \Maetva\Chronopost\ShippingServiceWS\StructType\SkybillWithDimensionsValueV6[]
     */
    ...
    public static function validateSkybillValueForArrayConstraintsFromSetSkybillValue(?array $values = []): string
    {
        ...
        foreach ($values as $shippingMultiParcelV5SkybillValueItem) {
            // validation for constraint: itemType
            if (!$shippingMultiParcelV5SkybillValueItem instanceof \Maetva\Chronopost\ShippingServiceWS\StructType\SkybillWithDimensionsValueV6) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The skybillValue property can only contain items of type \Maetva\Chronopost\ShippingServiceWS\StructType\SkybillWithDimensionsValueV6, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Maetva\Chronopost\ShippingServiceWS\StructType\SkybillWithDimensionsValueV6 $item
     * @return \Maetva\Chronopost\ShippingServiceWS\StructType\ShippingMultiParcelV5
     */
    public function addToSkybillValue(\Maetva\Chronopost\ShippingServiceWS\StructType\SkybillWithDimensionsValueV6 $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Maetva\Chronopost\ShippingServiceWS\StructType\SkybillWithDimensionsValueV6) {
            throw new InvalidArgumentException(sprintf('The skybillValue property can only contain items of type \Maetva\Chronopost\ShippingServiceWS\StructType\SkybillWithDimensionsValueV6, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
    ...
    public static function validateScheduledValueForArrayConstraintsFromSetScheduledValue(?array $values = []): string
    {
        ...
        foreach ($values as $shippingMultiParcelV5ScheduledValueItem) {
            // validation for constraint: itemType
            if (!$shippingMultiParcelV5ScheduledValueItem instanceof \Maetva\Chronopost\ShippingServiceWS\StructType\ScheduledValue) {
     ...
     * @return \Maetva\Chronopost\ShippingServiceWS\StructType\RecipientLocalValueV2[]
     */
    ...
    public static function validateRecipientLocalValueForArrayConstraintsFromSetRecipientLocalValue(?array $values = []): string
    {
        ...
        foreach ($values as $shippingMultiParcelV5RecipientLocalValueItem) {
            // validation for constraint: itemType
            if (!$shippingMultiParcelV5RecipientLocalValueItem instanceof \Maetva\Chronopost\ShippingServiceWS\StructType\RecipientLocalValueV2) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The recipientLocalValue property can only contain items of type \Maetva\Chronopost\ShippingServiceWS\StructType\RecipientLocalValueV2, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Maetva\Chronopost\ShippingServiceWS\StructType\RecipientLocalValueV2 $item
     * @return \Maetva\Chronopost\ShippingServiceWS\StructType\ShippingMultiParcelV5
     */
    public function addToRecipientLocalValue(\Maetva\Chronopost\ShippingServiceWS\StructType\RecipientLocalValueV2 $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Maetva\Chronopost\ShippingServiceWS\StructType\RecipientLocalValueV2) {
            throw new InvalidArgumentException(sprintf('The recipientLocalValue property can only contain items of type \Maetva\Chronopost\ShippingServiceWS\StructType\RecipientLocalValueV2, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
    ...
    public static function validateCustomsValueForArrayConstraintsFromSetCustomsValue(?array $values = []): string
    {
        ...
        foreach ($values as $shippingMultiParcelV5CustomsValueItem) {
            // validation for constraint: itemType
            if (!$shippingMultiParcelV5CustomsValueItem instanceof \Maetva\Chronopost\ShippingServiceWS\StructType\CustomsValue) {
