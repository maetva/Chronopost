...
class InfosPOD extends AbstractStructBase
{
     ...
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * @var \Drupal\commerce_chronopost\Endpoint\TrackingServiceWS\StructType\Event|null
     */
    protected ?\Drupal\commerce_chronopost\Endpoint\TrackingServiceWS\StructType\Event $significantEvent = null;
    /**
     * The skybillNumber
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     ...
     * @param \Drupal\commerce_chronopost\Endpoint\TrackingServiceWS\StructType\Event $significantEvent
     * @param string $skybillNumber
     */
    public function __construct(?string $dateDeposit = null, ?string $depositCountry = null, ?string $depositZipCode = null, ?string $objectType = null, ?string $recipientCity = null, ?string $recipientCountry = null, ?string $recipientName = null, ?string $recipientRef = null, ?string $recipientZipCode = null, ?string $shipperCity = null, ?string $shipperRef = null, ?string $shipperZipCode = null, ?\Drupal\commerce_chronopost\Endpoint\TrackingServiceWS\StructType\Event $significantEvent = null, ?string $skybillNumber = null)
    {
        $this
     ...
     * @return \Drupal\commerce_chronopost\Endpoint\TrackingServiceWS\StructType\Event|null
     */
    public function getSignificantEvent(): ?\Drupal\commerce_chronopost\Endpoint\TrackingServiceWS\StructType\Event
    {
     ...
     * @return \Drupal\commerce_chronopost\Endpoint\TrackingServiceWS\StructType\InfosPOD
     */
    public function setSignificantEvent(?\Drupal\commerce_chronopost\Endpoint\TrackingServiceWS\StructType\Event $significantEvent = null): self
    {
