...
class ResultSearchPODWithSenderRef extends AbstractStructBase
{
     ...
     * - minOccurs: 0
     * - nillable: true
     * @var \Maetva\Chronopost\TrackingServiceWS\StructType\ParcelPOD[]
     */
     ...
     * @param \Maetva\Chronopost\TrackingServiceWS\StructType\ParcelPOD[] $listParcelPOD
     */
     ...
     * Set errorCode value
     * @param int $errorCode
     * @return \Maetva\Chronopost\TrackingServiceWS\StructType\ResultSearchPODWithSenderRef
     */
    ...
    public static function validateListParcelPODForArrayConstraintsFromSetListParcelPOD(?array $values = []): string
    {
        ...
        foreach ($values as $resultSearchPODWithSenderRefListParcelPODItem) {
            ...
            if (!$resultSearchPODWithSenderRefListParcelPODItem instanceof \Maetva\Chronopost\TrackingServiceWS\StructType\ParcelPOD) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The listParcelPOD property can only contain items of type \Maetva\Chronopost\TrackingServiceWS\StructType\ParcelPOD, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Maetva\Chronopost\TrackingServiceWS\StructType\ParcelPOD $item
     * @return \Maetva\Chronopost\TrackingServiceWS\StructType\ResultSearchPODWithSenderRef
     */
    public function addToListParcelPOD(\Maetva\Chronopost\TrackingServiceWS\StructType\ParcelPOD $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Maetva\Chronopost\TrackingServiceWS\StructType\ParcelPOD) {
            throw new InvalidArgumentException(sprintf('The listParcelPOD property can only contain items of type \Maetva\Chronopost\TrackingServiceWS\StructType\ParcelPOD, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
